        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            <Badge className="mb-6 bg-primary/20 text-primary border-primary/50">
              📍сухой порт г. Екатеринбург • Доставка по РФ
            </Badge>
            <h1 className="lg:text-7xl mb-6 bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent mx-0 font-extralight text-left text-3xl">
              СВЕТИЛЬНИКИ: ОТ СТАНДАРТНЫХ МОДЕЛЕЙ ДО ЭКСКЛЮЗИВНЫХ СВЕТОВЫХ ФОРМ.
            </h1>
            <p className="lg:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-left text-base">Добро пожаловать в "Магазин Светильников . РФ". 
⚡️Здесь вы найдете светильники для интерьерных, экстерьерных и ландшафтных проектов. 
⚡️Мы поставляем продукцию ведущих мировых брендов со склада и под заказ, а также предлагаем модели собственного производства. 
⚡️Поможем создать световое решение, которое подчеркнет вашу индивидуальность.</p>
