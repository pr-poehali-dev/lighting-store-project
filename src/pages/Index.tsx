      ...
      <section id="home" className="relative overflow-hidden py-20 lg:py-32">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-left">Добро пожаловать в «Магазин Светильников . РФ», здесь вы найдете дизайнерские светильники для интерьера, экстерьера и ландшафта (МАФ). 
Мы продаем как под заказ так и со склада светильники от мировых брендов. Также есть позиции из собственного производства. 
Создайте уникальное освещение!</p>
